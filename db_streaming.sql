...
CREATE TABLE PASSWORD_CODE (
	ID_PASSWORD_CODE INT PRIMARY KEY IDENTITY(1, 1),
	ID_USER INT NOT NULL,
...
CREATE TABLE EMAIL_SENDER (
	ID_EMAIL_SENDER INT PRIMARY KEY IDENTITY(1, 1),
...
CREATE TABLE TEMPLATE (
	ID_TEMPLATE INT PRIMARY KEY IDENTITY(1, 1),
	NAME VARCHAR(50) NOT NULL
)

CREATE TABLE TEMPLATE_VARIABLE (
	ID_TEMPLATE_VARIABLE INT PRIMARY KEY IDENTITY(1, 1),
	NAME VARCHAR(30) NOT NULL,
...
CREATE TABLE TEMPLATE_CONTENT (
	ID_TEMPLATE_CONTENT INT PRIMARY KEY IDENTITY(1, 1),
	NAME VARCHAR(50) NOT NULL,
