...
CREATE TABLE FILM_REGION (
	ID_FILM_REGION INT PRIMARY KEY IDENTITY(1, 1),
	NAME VARCHAR(50) NOT NULL,
...
CREATE TABLE SERIES_CATEGORY (
	ID_SERIES_CATEGORY INT PRIMARY KEY IDENTITY(1, 1),
...
CREATE TABLE SERIES_EPISODE_REGION (
	ID_SERIES_EPISODE_REGION INT PRIMARY KEY IDENTITY(1, 1),
	NAME VARCHAR(50) NOT NULL,
	CLASSIFICATION VARCHAR(5) NOT NULL,
	SYNOPSIS VARCHAR(200) NOT NULL,
...
CREATE TABLE SERIES_EPISODE_CONTENT (
	ID_SERIES_EPISODE_CONTENT INT PRIMARY KEY IDENTITY(1, 1),
	ID_SERIES_EPISODE INT NOT NULL,
	ID_CONTENT INT NOT NULL,
	FOREIGN KEY (ID_SERIES_EPISODE)
	REFERENCES SERIES_EPISODE(ID_SERIES_EPISODE),
